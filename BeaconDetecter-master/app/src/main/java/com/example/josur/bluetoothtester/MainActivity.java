        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if(service instanceof BeaconServiceOld.LocalBinder){
                ...
                regionsNewBeaconService.setListener(new BeaconListener() {
                    @Override
                    public void beaconRecieved(String uuid, int minor, int mayor, int P, int Id, int T) {
                        Log.e("","");
                        if(!beacons.contains(uuid)){
                            ...
                            ((TextView)view.findViewById(R.id.textView)).setText(""+(P)+" PSI");
                            ((TextView)view.findViewById(R.id.textView2)).setText(""+Id);
                            ((TextView)view.findViewById(R.id.textView3)).setText("" + T+"°C");
